...
# Version RetroDriven - Changes for updating cores from @RetroDriven
...
SCRIPT_URL="${URL}/RetroDriven/MiSTer_UnofficialCores/tree/master/Updater/mister_updater_retrodriven.sh"
